                        ...
                        for (DocumentSnapshot document : task.getResult()){
                            if (position == 0) {
                                if (document.getString("isLocal").equals("true")) {
                                    ...
                                    if (event.getIsDonate() == null) {
                                        event.setIsDonate("false");
                                    }
                                    if (event.getTimeDonate() == null) {
                                        event.setTimeDonate("0");
                                    }
                                    if (event.getMoneyDonate() == null) {
                                        event.setMoneyDonate("0");
                                    }
                                    events.add(event);
                                }
                            } else if (position == 1) {
