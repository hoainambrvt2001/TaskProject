...
public class Event implements Parcelable {
    ...
    public Event(String name, String organizers, String location, String description, String startTime, String startDate, String dueTime, String dueDate, String eventID, String image, String isLocal, String limitRegister, String isDonate, String timeDonate, String moneyDonate, ArrayList<User> usersList) {
        this.name = name;
    ...
    public Event(String name, String organizers, String location, String description, String startTime, String startDate, String dueTime, String dueDate, String eventID, String image, String isLocal, String limitRegister, ArrayList<User> usersList) {
        this.name = name;
        this.organizers = organizers;
        this.location = location;
        this.description = description;
